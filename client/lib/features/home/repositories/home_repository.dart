...
class HomeRepository {
  Future<Either<AppFailure, String>> uploadSong({
    ...
    try {
      //For multiple request we use MultiPartRequest
      final request = http.MultipartRequest(
          'POST', Uri.parse("${ServerConstants.serverUrl}/song/upload"));
      request
        //Adding files like song and thumbnail
        ..files.addAll(
          [
        ...
        //Fields also sent to server logic
        ..fields.addAll(
          {
            'artist': artistName,
            'song_name': songName,
  ...
  Future<Either<AppFailure, bool>> getFavSong({
    required String token,
